...
#| message: false
library(tidyverse)
buoy <- read_table("../student/data/buoy_2024.txt")
head(buoy, 10)[,1:7]
```
...
#| message: false
library(tidyverse)
buoy2 <- read_table("../student/data/buoy_2024.txt",
                   comment = "#")
head(buoy2, 10)[,1:7]
```
...
#| echo: false
#| message: false
your_file_name <- read_csv("../student/data/buoy_update.csv",col_types = cols(.default = col_character()),
                          na = c("99", "999"))

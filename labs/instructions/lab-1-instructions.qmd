...
![Screenshot of new project option in RStudio under the project name in RStudio](images/create-new-project.png)  
...
![Image of New Project Wizard in RStudio where students should select New Project](images/choose-new-project.png)
...
![Image of New Project Wizard with options for New Directory, Existing Director, and Version Control](images/choose-new-directory.png)
...
![Create New Project window of New Project Wizard in RStudio that allows for specification of Directory Name and File Location](images/set-directory-name-location.png)
